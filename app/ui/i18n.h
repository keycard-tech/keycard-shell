...
typedef enum {
  ...
  MENU_CONNECT_OTHERS,
  MENU_CONNECT_LEDGER_LIVE,
  MENU_CONNECT_LEDGER_LEGACY,
  MENU_CONNECT_BITCOIN_ALT,
  MENU_CONNECT_BITCOIN_MULTISIG_ALT,
  MENU_CONNECT_SELECT_ACCOUNT,
  ...
  ADDRESS_VERIFY_TITLE,
  ADDRESS_VERIFY_WAIT_SUB,
  ADDRESS_VERIFY_FOUND_MSG,
  ADDRESS_VERIFY_FOUND_SUB,
  ADDRESS_VERIFY_NOT_FOUND_MSG,
  ADDRESS_VERIFY_NOT_FOUND_SUB,
  ADDRESS_VERIFY_INVALID_MSG,
  ADDRESS_VERIFY_INVALID_SUB,
  ...
  MENU_VERIFY_MNEMO,
  MNEMO_VERIFY_PASS_PROMPT,
  INFO_VERIFY_MNEMO_MATCH_MSG,
  INFO_VERIFY_MNEMO_MATCH_SUB,
  INFO_VERIFY_MNEMO_MISMATCH_MSG,
  INFO_VERIFY_MNEMO_MISMATCH_SUB,

  // Device verification
  DEV_AUTH_TITLE,
  DEV_AUTH_PROMPT_STEP1,
  DEV_AUTH_PROMPT_STEP2,
  DEV_AUTH_PROMPT_STEP3,
  DEV_AUTH_INVALID_QR,
  ...
  MENU_MULTISIG_EXPORT,
  MENU_MULTISIG_VERIFY,
  MENU_MULTISIG_DELETE,
  MULTISIG_TITLE,
  MULTISIG_IMPORT_CONFIRM,
  MULTISIG_IMPORT_OK_MSG,
  MULTISIG_IMPORT_OK_SUB,
  MULTISIG_IMPORT_INVALID_MSG,
  MULTISIG_IMPORT_INVALID_SUB,
  MULTISIG_NO_DESCRIPTORS_MSG,
  MULTISIG_NO_DESCRIPTORS_SUB,
  MULTISIG_PICK_TITLE,
  MULTISIG_DELETE_CONFIRM,
  MULTISIG_DELETE_OK_MSG,
  MULTISIG_DELETE_OK_SUB,
  MULTISIG_ADDR_TITLE,
