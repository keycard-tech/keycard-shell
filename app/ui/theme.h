...
#define TH_COLOR_DISABLED SCREEN_RGB(0x3a, 0x3a, 0x3a)
...
#define TH_COLOR_TITLE_ICON TH_COLOR_FG
#define TH_COLOR_TITLE_ICON_INVERT TH_COLOR_BG
#define TH_COLOR_TITLE_ICON_WARN TH_COLOR_ERROR
...
#define TH_FONT_TITLE &shell_18px
#define TH_FONT_TEXT &shell_16px
#define TH_FONT_INFO &shell_18px
...
#define TH_QRCODE_VERTICAL_MARGIN 4
#define TH_QRCODE_ADDR_MARGIN 52
#define TH_QRCODE_MSG_LABEL_HEIGHT 28
#define TH_QRCODE_MSG_BOX_MARGIN 8
...
#define TH_KEYBOARD_KEY_SUGGESTION_SIZE ((TH_KEYBOARD_KEY_SIZE * 3) + (TH_KEYBOARD_KEY_MARGIN * 2))
#define TH_KEYBOARD_KEY_BG SCREEN_RGB(0x19, 0x19, 0x19)
#define TH_KEYBOARD_KEY_SELECTED_BG TH_COLOR_ACCENT
#define TH_KEYBOARD_KEY_DISABLED_BG SCREEN_RGB(0x0d, 0x0d, 0x0d)
#define TH_KEYBOARD_KEY_DISABLED_SELECTED_BG TH_COLOR_ACCENT
#define TH_KEYBOARD_KEY_FG TH_COLOR_FG
#define TH_KEYBOARD_KEY_SELECTED_FG TH_COLOR_FG
#define TH_KEYBOARD_KEY_DISABLED_FG TH_COLOR_DISABLED
#define TH_KEYBOARD_KEY_DISABLED_SELECTED_FG SCREEN_RGB(0x33, 0x33, 0x33)
...
#define TH_TEXT_FIELD_MARGIN (TH_SCREEN_MARGIN + 8)
...
#define TH_TEXT_FIELD_CURSOR_MARGIN 2

#define TH_NUM_PICKER_TOP (TH_TITLE_HEIGHT + 66)
#define TH_NUM_PICKER_FONT &shell_16px

#define TH_MNEMONIC_TOP_MARGIN 2
#define TH_MNEMONIC_10WORDS_TOP_MARGIN 16
#define TH_MNEMONIC_LEFT_MARGIN 16
#define TH_MNEMONIC_FIELD_WIDTH 144

#define TH_ORDER_INDEX_SIZE 24
#define TH_ORDER_INDEX_MARGIN 6
#define TH_ORDER_INDEX_COLOR TH_COLOR_INACTIVE
#define TH_ORDER_INDEX_INNER_MARGIN 1
...
#define TH_NAV_HINT_INPUT_LEFT_X (TH_NAV_HINT_LEFT_X + 29)
#define TH_NAV_HINT_INPUT_RIGHT_X 165
#define TH_NAV_HINT_INPUT_PROCEED_RIGHT_X 161
#define TH_NAV_HINT_INPUT_LEFT_WIDTH 100
#define TH_NAV_HINT_INPUT_RIGHT_WIDTH 120
#define TH_NAV_HINT_INPUT_TOP (TH_NAV_HINT_TOP + 2)

#define TH_NAV_PAGER_TOP TH_NAV_HINT_TOP

#define TH_INFO_ICON_TOP_MARGIN 22
#define TH_INFO_ICON_TOP_MARGIN_NO_SUB 34
#define TH_INFO_ICON_BOTTOM_MARGIN 16
#define TH_INFO_SUBTEXT_MARGIN 4

#define TH_PROMPT_VERTICAL_MARGIN 4

#define TH_DB_VERSION_BOX_HEIGHT 40
#define TH_DB_VERSION_BOX_VERTICAL_MARGIN 8
#define TH_DB_VERSION_BOX_COLOR SCREEN_RGB(0x19, 0x19, 0x19)
#define TH_DB_UPDATE_INSTRUCTION_TOP (TH_TITLE_HEIGHT + 60)
#define TH_DB_UPDATE_INSTR_MARGIN 6
